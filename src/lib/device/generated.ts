...
export const deviceOptions: DeviceOptions = [
  ...
  },
  {
    ...
    name: "Ball",
    description:
      "A physics ball that can be moved by firing at it with a gadget",
    optionSchema: {
      categories: {
        categories: [
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the ball respawns, how long (in seconds) does it take?",
            type: "numberInput",
            defaultValue: 3,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            label: "Hit Impact",
            description:
              "How much do projectiles impact the velocity of the ball?",
            type: "select",
            validators: [null],
            defaultValue: 1.5,
            props: {
        ...
        },
        {
          ...
          option: {
            label: "Bounce",
            description:
              "Set the bounciness of the ball (0 is no bounce, 100 is maximum bounce)",
            type: "numberInput",
            defaultValue: 70,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            label: "Friction",
            description:
              "Set how quickly the ball slows down. (0 is no friction, 100 is maximum friction)",
            type: "numberInput",
            defaultValue: 10,
            validators: [null],
            props: { min: 0, max: 100, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            label: "Mass",
            description:
              "Increasing the mass will make the ball harder to move. The size of the ball is also factored into the mass.",
            type: "select",
            validators: [null],
            defaultValue: 1.5,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the ball when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the ball when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            label: "Identifier",
            description:
              "Set a unique identifier for this ball, so it can be tracked by the Waypoint Device",
            type: "textInput",
            defaultValue: "",
            validators: [null],
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When ball enters the zone, the device sends a signal on the selected channel",
          },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the zone when the device receives a signal from the selected channel",
          },
          categories: ["Channels"],
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the barrier is activated/deactivated, who does that apply to?",
          },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the barrier when the device receives a signal from the selected channel",
          },
          categories: ["availability"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the barrier when the device receives a signal from the selected channel",
          },
          categories: ["availability"],
        },
        {
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "The message shown to player when they become within interaction distance of the button",
            type: "textInput",
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the button is pressed, the device sends a signal on the selected channel",
          },
          categories: ["featured", "channels"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How long does the player have to interact to press the button?",
            type: "select",
            validators: [null],
            defaultValue: 1,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the button when the device receives a signal from the selected channel",
          },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the button when the device receives a signal from the selected channel",
          },
          categories: ["availability", "channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the button is activated/deactivated, who does it apply to?",
          },
          categories: ["availability"],
        },
        {
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "Activate the camera point when the device receives a signal from the selected channel",
          },
        },
        {
          key: "deactivateChannel",
          option: {
            ...
            description:
              "Deactivate the camera point when the device receives a signal from the selected channel",
          },
        },
      ],
    },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The message shown to player when they become within interaction distance of the character",
            type: "textInput",
            defaultValue: "Talk",
            validators: [null],
            props: { placeholder: "Enter message here...", maxLength: 128 },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When interact with character, the device sends a signal on the selected channel",
            hideIf: [
              [
                {
                  key: "interactionEnabled",
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Can the player interact with character when the game starts?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the character when the device receives a signal from the selected channel",
          },
          categories: ["availability", "channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the character when the device receives a signal from the selected channel",
          },
          categories: ["availability", "channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the character is activated/deactivated, who does it apply to?",
          },
          categories: ["availability"],
        },
        {
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "Run the check when the device receives a signal from the selected channel",
          },
          categories: ["featured"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the check passes, the device sends a signal on the selected channel",
          },
          categories: ["featured"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the check fails, the device sends a signal on the selected channel",
          },
          categories: ["featured"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The name of the property to check for. The corresponding property must be a number to work properly.",
            hideIf: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "In order for the device to transmit a pass, do all checks need to pass or just one of them?",
            type: "select",
            validators: [null],
            defaultValue: "and",
            props: {
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How many times can a player activate this checkpoint?",
            type: "select",
            validators: [null],
            defaultValue: 0,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Set as active checkpoint when the device receives a signal from the selected channel",
          },
          categories: ["featured", "channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the this checkpoint is activated for a player, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "Activate class for triggering character when the device receives a signal from the selected channel",
          },
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Increment the counter by 1 when the device receives a signal from the selected channel",
          },
          categories: ["featured", "channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Decrement the counter by 1 when the device receives a signal from the selected channel",
          },
          categories: ["featured", "channels"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The name of the property to update. Must be a number property to work correctly.",
            hideIf: [
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How much of this item is required to craft this recipe?",
            type: "numberInput",
            defaultValue: 3,
            validators: [null],
            props: { min: 1, max: 999999999999999, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Should the item expire after a certain amount of time?",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            label: "Group",
            description:
              "If set, this recipe will only be available at tables with a matching group",
            type: "textInput",
            defaultValue: "",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Is this recipe available to craft when the game starts?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When item begins crafting, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When item is crafted, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate recipe when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate recipe when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
      ],
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The status of the crafting table (crafting, ready to collect, etc) is scoped to who?",
          },
          categories: ["featured"],
        },
        {
          ...
          option: {
            ...
            description:
              "If set, the crafting table will only be able to craft recipes with a matching group",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: { placeholder: "Text here...", category: "craftingGroup" },
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "When an item is crafted, does the crafter get the first chance to collect it?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When an item begins crafting, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When an item finishes crafting, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When an item is collected, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When an item expires, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
      ],
      ...
      options: [
        {
          ...
          option: {
            label: "Boost Amount",
            description:
              "When a deals damage, multiply the amount by this value",
            type: "select",
            validators: [null],
            defaultValue: 2,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the damage boost when the device receives a signal from the selected channel",
          },
        },
        {
          key: "deactivateChannel",
          option: {
            ...
            description:
              "Deactivate the damage boost when the device receives a signal from the selected channel",
          },
        },
      ],
    },
      ...
      options: [
        {
          ...
          option: {
            ...
            defaultValue: 15,
            validators: [null],
            props: { min: 1, max: 10000, step: 1, allowEmpty: false },
          },
        },
        {
          key: "damageOnChannel",
          option: {
            ...
            description:
              "Damage the triggering player when the device receives a signal from the selected channel",
          },
        },
        {
          ...
          option: {
            ...
            description:
              "When the damage applied knocks out a player, this message will be displayed in the activity feed. Use {name} to insert the player's name.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: { placeholder: "Text here..." },
  ...
  },
  {
    ...
    name: "Dialogue",
    description:
      "A dialogue box that can be interacted with to create rich conversations",
    optionSchema: {
      categories: {
        categories: [
          { id: "featured", name: "Featured" },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Set a group to show actions from matching Dialogue Action Devices",
            type: "textInput",
            defaultValue: "",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the first action button is clicked, the device sends a signal on the selected channel",
          },
          categories: ["featured", "actions"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the second action button is clicked, the device sends a signal on the selected channel",
          },
          categories: ["actions"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the third action button is clicked, the device sends a signal on the selected channel",
          },
          categories: ["actions"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the fourth action button is clicked, the device sends a signal on the selected channel",
          },
          categories: ["actions"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Open when the device receives a signal from the selected channel",
          },
          categories: ["featured", "channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Close when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When when the dialogue is closed, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
      ],
  ...
  },
  {
    ...
    description:
      "An action button that can be clicked on in the Dialogue Device",
    optionSchema: {
      categories: {
        categories: [
          { id: "featured", name: "Featured" },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            label: "Dialogue Group",
            description:
              "This action will be displayed on all Dialogue devices with the same group name",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: { placeholder: "Text here...", category: "dialogue" },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the action is clicked, the device sends a signal on the selected channel",
          },
          categories: ["featured"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the action is activated/deactivated, who does it apply to?",
          },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the action when the device receives a signal from the selected channel",
          },
          categories: ["activeAndScope"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the action when the device receives a signal from the selected channel",
          },
          categories: ["activeAndScope"],
        },
      ],
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "End the game when the device receives a signal from the selected channel",
          },
        },
      ],
    },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Featured widgets sit above all content. Primary widgets sit above the leaderboard. Secondary widgets sit beneath the leaderboard.",
            type: "select",
            validators: [null],
            defaultValue: "Primary",
            props: {
        ...
        },
        {
          ...
          option: {
            label: "Property",
            description:
              "Name of the property used for the statistic. Should match up with a Property Device.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Is this widget ready to be shown at the end of the game by default?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the widget when the device receives a signal from the selected channel",
          },
          categories: ["channelsAndActive"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the widget when the device receives a signal from the selected channel",
          },
          categories: ["channelsAndActive"],
        },
      ],
  ...
  },
  {
    ...
    name: "Flag",
    description:
      "A flag that can be carried around and used for Capture The Flag games",
    optionSchema: {
      categories: {
        categories: [
          { id: "featured", name: "Featured" },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The team that this flag belongs to. Players on this team won't be able to pick up the flag.",
            type: "select",
            validators: [null],
            defaultValue: "1",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, an area will exist around the flag that will prevent the protecting team from entering it",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How long (in seconds) the flag will return to the base after it is dropped",
            type: "numberInput",
            defaultValue: 15,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Send an alert to the protecting team when the flag is picked up",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the flag is captured, the device sends a signal on the selected channel",
          },
          categories: ["featured", "channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Capture the flag and return it to the base when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the flag is picked up, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the flag is picked up from the base, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the flag is dropped, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Force the flag to drop when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the flag is returned to base, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the flag is returned to the base manually, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Force the flag to return to base when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            defaultValue: 200,
            validators: [null],
            props: { min: 150, max: 1000, step: 1, allowEmpty: false },
            hidden: true,
          },
        },
      ],
  ...
  },
  {
    ...
    description:
      "Automatically capture a flag when a player enters the zone with one",
    optionSchema: {
      categories: {
        categories: [
          { id: "Featured", name: "Featured" },
      ...
      options: [
        {
          ...
          option: {
            label: "Flag Color",
            description:
              "The color of the flag the zone listens for. When a player enters the zone with a flag of this color, the flag is captured.",
            type: "select",
            validators: [null],
            defaultValue: "black",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, the zone will be active when the game starts",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the flag is captured in the zone, the device sends a signal on the selected channel",
          },
          categories: ["Featured", "Channels"],
        },
        {
  ...
  },
  {
    ...
    name: "Game Overlay",
    description:
      "Display text or a button on-screen for players during the game",
    optionSchema: {
      categories: {
        categories: [
          { id: "featured", name: "Featured" },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Which corner of the screen the overlay will appear in",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, the maximum amount of the tracked item will be shown (e.g: 70/100)",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When a player clicks the overlay button, the device sends a signal on the selected channel",
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the overlay content is updated, who is it applied to?",
            hideIf: [
              [{ key: "type", compare: "EQUAL", value: "Tracked Item" }],
            ],
          },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the overlay is shown/hidden, who does it apply to?",
          },
          categories: ["scope"],
        },
        {
          ...
          option: {
            ...
            description:
              "Show the overlay when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Hide the overlay when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
      ],
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            label: "Grant Type",
            description:
              "Grant just health, just shield, or health first, then shield (if leftovers)",
            type: "select",
            validators: [null],
            defaultValue: "health",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Grant health to the triggering player when the device receives a signal from the selected channel",
          },
        },
      ],
    },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate this manager for the triggering player when the device receives a signal from the selected channel",
          },
          categories: ["featured", "channels"],
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Set a specific maximum amount a player is allowed to hold of this item",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The maximum amount a player is allowed to hold of this item",
            type: "numberInput",
            defaultValue: 10,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Decide if the item should be deleted or kept when a player respawns",
            type: "select",
            validators: [null],
            defaultValue: "Keep",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Remove all of this item from a player's inventory when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How much of the selected item should be granted/taken away?",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Grant the item to the triggering player when the device receives a signal from the selected channel",
          },
          categories: ["featured"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the inventory is full, how should the item be granted?",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "If granting a gadget, set a custom amount of projectiles loaded into the gadget by default. If left empty, the gadget's default amount will be used.",
            type: "numberInput",
            validators: [null],
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            label: "Outline Size",
            description:
              "Select what strategy to use for the size of the outline",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the item image is shown/hidden, who does it apply to?",
          },
          categories: ["availability"],
        },
        {
          ...
          option: {
            ...
            description:
              "Show the item image when the device receives a signal from the selected channel",
          },
          categories: ["availability"],
        },
        {
          ...
          option: {
            ...
            description:
              "Hide the item image when the device receives a signal from the selected channel",
          },
          categories: ["availability"],
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The amount of the selected item player receive when they collect it",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
            props: { min: 1, max: 999999999999999, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the item is collected, how long should it take before the item respawns?",
            type: "select",
            validators: [null],
            defaultValue: 1000,
            props: {
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the specified target is knocked out, the device sends a signal on the selected channel",
          },
          categories: ["featured", "channels"],
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Grant an item to the player when they are knocked out",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Is this knockout manager active when the game starts?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
      ],
      ...
      options: [
        {
          ...
          option: {
            label: "Damage Dealt",
            description:
              "Amount of damage dealt to players when hit by the laser beam",
            type: "numberInput",
            defaultValue: 10,
            validators: [null],
            props: { min: 0, max: 500000, step: 1, allowEmpty: false },
          },
          categories: ["featured"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the laser is activated/deactivated, who does it apply to?",
          },
        },
        {
          ...
          option: {
            ...
            description:
              "When a player is hit, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the laser when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the laser when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "When the laser is inactive, show a dotted path showing the start & end points",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
      ...
      options: [
        {
          ...
          option: {
            label: "Laser Group",
            description:
              "The group of lasers the manager will update. Leave empty to update all lasers without a group.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: { placeholder: "Group name...", category: "laserGroup" },
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Automatically active & deactivate lasers at a set interval",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the managed lasers when the device receives a signal from the selected channel",
          },
        },
        {
          key: "deactivateOnChannel",
          option: {
            ...
            description:
              "Deactivate the managed lasers when the device receives a signal from the selected channel",
          },
        },
      ],
    },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When when the event occurs, the device sends a signal on the selected channel",
          },
        },
      ],
    },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How long (in minutes) the game will last. The game automatically ends when the countdown completes.",
            type: "numberInput",
            defaultValue: 10,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Will only use the game clock when the mode type matches",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Can the game host start the game with only themselves?",
            type: "select",
            validators: [null],
            defaultValue: 1,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "For players that join after the game has started, should they join as spectators?",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Are ally indicators enabled? The ally indicator show friendly players with green text, and puts an arrow over their Gims.",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Are enemy indicators enabled? The enemy indicator shows enemy players with red text.",
            type: "select",
            validators: [null],
            defaultValue: "Disabled",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Is the game host allowed to spectate or are they forced to join?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "What percentage of max health a player has at the start of the game",
            type: "select",
            validators: [null],
            defaultValue: 100,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "What percentage of max shield a player has at the start of the game",
            type: "select",
            validators: [null],
            defaultValue: 100,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How long (in seconds) players are immune after respawning",
            type: "numberInput",
            defaultValue: 10,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Can players refill gadgets without having the required resource?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When players need to refill their gadgets, how long does it take?",
            type: "select",
            validators: [null],
            defaultValue: false,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Are players allowed to drop gadgets from their inventory?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Are players allowed to drop usable items from their inventory?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Are players allowed to drop resources from their inventory?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Set what happens to a player's gadget when they respawn",
            type: "select",
            validators: [null],
            defaultValue: "Keep",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Set what happens to a player's usable items when they respawn",
            type: "select",
            validators: [null],
            defaultValue: "Keep",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Set what happens to a player's resources when they respawn",
            type: "select",
            validators: [null],
            defaultValue: "Keep",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Are gadgets that use durability, such as pickaxes, indestructible?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            label: "Score Item",
            description:
              "The tracked item which determines a player's ranking on the leaderboard",
            type: "itemId",
            defaultValue: "cash",
            validators: [null],
            props: {},
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The tracked property which determines a player's ranking on the leaderboard",
            hideIf: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Are players sorted from lowest to highest, or highest to lowest?",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Show a player's placement ranking at the end of a game",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Prevent knockout messages from appearing in the activity feed",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "When players build structures, and then their connection to a solid base is removed, should the builds float?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The amount of the tracked item to remove from the player's inventory",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
            props: { min: 1, max: 1000000000, step: 1, allowEmpty: false },
          },
          categories: ["featured"],
        },
        {
          ...
          option: {
            ...
            description:
              "How often to drain the tracked item from the player's inventory",
            type: "select",
            validators: [null],
            defaultValue: 500,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the player runs out of the tracked resource, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the player runs out of the tracked item, what should their speed be set to? 1 is default speed, 0.5 is half speed, 2 is double speed, etc.",
            type: "numberInput",
            defaultValue: 0,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Transmit when the player has reaches than this amount or less of the tracked item",
            type: "numberInput",
            defaultValue: 5,
            validators: [null],
            props: { min: 1, max: 1000000000, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the amount of the tracked item reaches the warning amount, the device sends a signal on the selected channel",
          },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the movement meter when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the movement meter when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
      ],
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Send the notification when the device receives a signal from the selected channel",
          },
          categories: ["featured"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Which corner of the screen the notification will appear in",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Set a manual duration or let the notification disappear automatically based off the length of the content",
            type: "select",
            validators: [null],
            defaultValue: "auto",
            props: {
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            defaultValue: 200,
            validators: [null],
            props: { min: 0, max: 10000, step: 1, allowEmpty: false },
            hideIf: [
        ...
        },
        {
          ...
          option: {
            label: "Circle Radius",
            description:
              "What is the value of the circle radius for cirle making the outline?",
            type: "numberInput",
            defaultValue: 200,
            validators: [null],
            props: { min: 0, max: 10000, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "What percentage of the circle we show for the outline?",
            type: "numberInput",
            defaultValue: 100,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Should the circle be fully filled? The style (dashed or not) does not make a difference then.",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How thick is the line making up the outline (in pixels)?",
            type: "numberInput",
            defaultValue: 5,
            validators: [null],
            props: { min: 1, max: 50, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            label: "Alpha",
            description:
              "Set the transparency of the outline. 0 is completely transparent, 1 is completely visible.",
            type: "numberInput",
            defaultValue: 0.8,
            validators: [null],
            props: { min: 0.01, max: 1, step: 0.01, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            label: "Dash Lenght",
            description:
              "How long is the dash for the dashed outline (in pixels)?",
            type: "numberInput",
            defaultValue: 35,
            validators: [null],
            props: { min: 0, max: 100, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            label: "Dash Spacing",
            description:
              "What is the space between dashes for the dashed outline (in pixels)?",
            type: "numberInput",
            defaultValue: 15,
            validators: [null],
            props: { min: 0, max: 100, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Show the outline when the device receives a signal from the selected channel",
          },
        },
        {
          key: "hideChannel",
          option: {
            ...
            description:
              "Hide the outline when the device receives a signal from the selected channel",
          },
        },
        {
          key: "scope",
          option: {
            ...
            description:
              "When the outline is shown/hidden, who does that apply to?",
          },
        },
      ],
    },
  ...
  },
  {
    ...
    description:
      "Detect when a player's position changes and get their coordinates",
    optionSchema: {
      options: [
        {
          ...
          option: {
            ...
            description:
              "When a player's position changes, the device sends a signal on the selected channel",
          },
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The name of the property to update when the X position changes. Must be a number property to work correctly.",
            hideIf: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The name of the property to update when the Y position changes. Must be a number property to work correctly.",
            hideIf: [
              [{ key: "updateProperties", compare: "NOT_EQUAL", value: true }],
            ],
          },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            label: "Detect For...",
            description:
              "A match should only be found for which kind of players?",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            label: "Broadcast As",
            description:
              "When a match/loss occurs, the message should be broadcasted as?",
            type: "select",
            validators: [null],
            defaultValue: "everybody",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How far away (in tiles) must two players be for a match to be found",
            type: "numberInput",
            defaultValue: 1.5,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            label: "Wait",
            description:
              "How long (in seconds) two players need to be within proximity for a match to be found",
            type: "numberInput",
            defaultValue: 0,
            validators: [null],
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            label: "Content Text",
            description:
              "Content shown in smaller text. Use for descriptions & additional info.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: { placeholder: "Text here...", maxLength: 512 },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Open the popup when the device receives a signal from the selected channel",
          },
          categories: ["Featured", "Channels"],
        },
        {
          ...
          option: {
            label: "Icon Image",
            description:
              "Small icon image shown above the header & content. Custom images are not allowed. Refer to the Gimkit Creative documentation for usage of icon images.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: { placeholder: "Text here...", maxLength: 128 },
        ...
        },
        {
          ...
          option: {
            label: "Popup Style",
            description:
              "Modal: a large popup the obstructs the center of the screen. Banner: a smaller popup that slides up from the bottom.",
            type: "select",
            validators: [null],
            defaultValue: "modal",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Label shown on call to action button. Leave empty for no call to action.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Channel to transmit on when call to action is clicked",
          },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Label shown on secondary call to action button. Leave empty for no secondary call to action.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: { placeholder: "Text here...", maxLength: 32 },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Channel to transmit on when secondary call to action is clicked",
          },
          categories: ["Call To Action", "Channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the content of the popup is updated, who does it apply to?",
          },
        ...
        },
        {
          ...
          option: {
            label: "Background Color",
            description:
              "Background color of the popup. The text color will automatically adapt to be readable",
            type: "color",
            defaultValue: "#FFFFFF",
            validators: [null],
          },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Close the popup when the device receives a signal from the selected channel",
          },
          categories: ["Channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When popup closed, the device sends a signal on the selected channel",
          },
          categories: ["Channels"],
        },
      ],
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Lower means more variability in terrain. Higher means less variability.",
            type: "numberInput",
            defaultValue: 5,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            label: "Seed",
            description:
              "Set a seed to produce the same terrain every time. Leave blank for random.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            label: "Weight",
            description:
              "Increase the weight to make this terrain more likely to be placed",
            type: "numberInput",
            defaultValue: 100,
            validators: [null],
            props: { min: 1, max: 1000000, step: 1, allowEmpty: false },
          },
        },
        {
          key: "constraint1",
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            label: "Alpha",
            description:
              "Adjust the transparency of the prop. 0 is invisible, 1 is fully visible.",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Show prop when the device receives a signal from the selected channel",
          },
          categories: ["availability"],
        },
        {
          ...
          option: {
            ...
            description:
              "Hide prop when the device receives a signal from the selected channel",
          },
          categories: ["availability"],
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, the prop can be damaged by player gadgets",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the prop is destroyed, the device sends a signal on the selected channel",
            hideIf: [
              [
                {
                  key: "visibilityScope",
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, the prop will increase in health with each player in-game.",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Amount of health to give the prop per additional player.",
            type: "numberInput",
            defaultValue: 25,
            validators: [null],
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When this property is updated, the value is applied to who?",
          },
        },
        {
          ...
          option: {
            ...
            description:
              "When the value of the property changes, the device sends a signal on the selected channel",
          },
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "When the game begins, should the property be marked as changed?",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
  ...
  },
  {
    ...
    name: "Questioner",
    description:
      "Bring in a kit for players to answer multiple choice questions",
    optionSchema: {
      categories: {
        categories: [
          { id: "featured", name: "Featured" },
      ...
      options: [
        {
          ...
          option: {
            label: "Kit Link",
            description:
              "Paste in the link of the kit you want players to answer questions from",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: {
              placeholder:
                "https://www.gimkit.com/view/5be31abedf23350022e7d871",
              maxLength: 128,
            },
          },
          categories: ["featured"],
        },
        {
          ...
          option: {
            ...
            description:
              "When a player answers a question correctly, the device sends a signal on the selected channel",
          },
          categories: ["featured", "channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When a player answers a question incorrectly, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Open the question answering screen when the device receives a signal from the selected channel",
          },
          categories: ["featured", "channels"],
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Once the answering screen is opened, can it be closed by the player?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The message shown to the player when they answer correctly",
            type: "textInput",
            defaultValue: "",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The message shown to the player when they answer incorrectly",
            type: "textInput",
            defaultValue: "",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the correct/incorrect message is updated from within Blocks, who does it apply to?",
          },
          categories: ["interface"],
        },
        {
          ...
          option: {
            ...
            description:
              "Close the question answering screen when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the question answering screen is opened, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the question answering screen is closed, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            label: "Sound",
            description:
              "Sounds played when a player answers a question correctly or incorrectly",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Once a player answers a question correctly, replace the close button with a custom call to action?",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Text shown on the button after a player answers a question correctly",
            type: "textInput",
            defaultValue: "",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When a player clicks the custom action button, the device sends a signal on the selected channel",
            hideIf: [
              [{ key: "useCustomAction", compare: "NOT_EQUAL", value: true }],
            ],
          },
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "Select the audience to relay the message on behalf of",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The channel the relayed message will be transmitted on for each player in the selected audience",
          },
        },
        {
          ...
          option: {
            ...
            description:
              "Relay when the device receives a signal from the selected channel",
          },
        },
      ],
    },
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "Start the repeater when the device receives a signal from the selected channel",
          },
          categories: ["featured"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the repeater runs the task, the device sends a signal on the selected channel",
          },
          categories: ["featured"],
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How many times the repeater will run a task before stopping",
            type: "numberInput",
            defaultValue: 5,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Stop the repeater when the device receives a signal from the selected channel",
            hideIf: [
              [
                {
                  key: "stopRepeatingStrategy",
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The maximum number of tasks that can be running at the same time for each player",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, the task will run when the repeater starts. If disabled, it will wait until the first interval to run the task",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "Respawn the triggering player when the device receives a signal from the selected channel",
          },
        },
      ],
    },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            label: "Aim Accuracy",
            description:
              "Customize how accurate the sentry is when aiming at players",
            type: "select",
            validators: [null],
            defaultValue: 0.5,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            defaultValue: 100,
            validators: [null],
            props: { min: 1, max: 100000, step: 1, allowEmpty: false },
          },
        ...
        },
        {
          ...
          option: {
            ...
            defaultValue: 0,
            validators: [null],
            props: { min: 0, max: 100000, step: 1, allowEmpty: false },
          },
          categories: ["health"],
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, the sentry will increase its health and shield based on the number of players in the game.",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            label: "Sentry Team",
            description:
              "Set the team the Sentry belongs to. The Sentry will not attack other players/sentries on the same team.",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            label: "Respawn Duration (Seconds)",
            description:
              "When knocked out, how many seconds does the sentry take to respawn?",
            type: "numberInput",
            defaultValue: 10,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            label: "Sentry Name",
            description:
              "Set a custom name for this sentry, shown when a player causes it to get knocked out",
            type: "textInput",
            defaultValue: "",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            defaultValue: 1000,
            validators: [null],
            props: { min: 250, max: 5000, step: 1, allowEmpty: false },
            hidden: true,
          },
        },
        {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How many of the item does this sentry drop when knocked out?",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
            props: { min: 1, max: 999999999, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the sentry is knocked out, the device sends a signal on the selected channel",
          },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the sentry when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the sentry when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
      ],
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Which phase of the game should this spawn pad be used?",
            type: "select",
            validators: [null],
            defaultValue: "All",
            props: {
      ...
      options: [
        {
          ...
          option: {
            label: "Speed",
            description:
              "Speed the player will move at. 1 is default speed, 0.5 is half speed, 2 is double speed, etc.",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
            props: { min: 0, max: 4, step: 0.01, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Set the triggering player to the configured speed when the device receives a signal from the selected channel",
          },
        },
      ],
    },
      ...
      options: [
        {
          ...
          option: {
            label: "Item To Grant",
            description:
              "The item that will be granted to the player at the start of the game",
            type: "itemId",
            validators: [null],
            props: {},
          },
        },
        {
          ...
          option: {
            ...
            description:
              "The amount of the item that will be granted to the player at the start of the game",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
            props: { min: 1, max: 999999999999999, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If the item is a gadget or usable, should it be automatically equipped when granted?",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Should the item still be granted for players that have a save? This could allow players to duplicate the item by loading in, leaving, and then rejoining.",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If disabled, then this item will not be granted to the player.",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When a player is tagged, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When a player tags another player, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
        ...
        },
        {
          ...
          option: {
            label: "Tag Area",
            description:
              "Set up tagging across the entire map or within a specific area",
            type: "select",
            validators: [null],
            defaultValue: "everywhere",
            props: {
        ...
        },
        {
          ...
          option: {
            label: "Tag Distance",
            description:
              "Distance (in tiles) two players can be apart before a tag is registered",
            type: "numberInput",
            defaultValue: 1.5,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the tag zone when the device receives a signal from the selected channel",
          },
          categories: ["availability", "channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the tag zone when the device receives a signal from the selected channel",
          },
          categories: ["availability", "channels"],
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When a player joins this team, the device sends a signal on the selected channel",
          },
        },
        {
          key: "maxPlayers",
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            label: "Target Group",
            description:
              "When a player enters, they will teleport to a teleporter with this group",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When a player is teleported here, the device sends a signal on the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Teleport to this teleporter when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Teleport to the teleporter's target when the device receives a signal from the selected channel",
          },
          categories: ["channels"],
        },
        {
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When the content of the text changes, who does it apply to?",
          },
          categories: ["featured"],
        },
        {
        ...
        },
        {
          ...
          option: {
            label: "Alpha",
            description:
              "Set the transparency of the text. 1 is fully visible, 0 is invisible.",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Show the text when the device receives a signal from the selected channel",
          },
          categories: ["availability"],
        },
        {
          ...
          option: {
            ...
            description:
              "Hide the text when the device receives a signal from the selected channel",
          },
          categories: ["availability"],
        },
      ],
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "When this trigger is triggered, the device sends a signal on the selected channel",
          },
          categories: ["featured"],
        },
        {
        ...
        },
        {
          ...
          option: {
            label: "Trigger Delay",
            description:
              "Once triggered, how long (in seconds) does it wait before taking action?",
            type: "numberInput",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Is the trigger active and ready to transmit when the game starts?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate this trigger when the device receives a signal from the selected channel",
          },
          categories: ["availability"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate this trigger when the device receives a signal from the selected channel",
          },
          categories: ["availability"],
        },
        {
          ...
          option: {
            ...
            description:
              "When the trigger is activated/deactivated, who does it apply to?",
          },
          categories: ["availability"],
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Can this trigger be triggered by a player stepping over it?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "When a player purchases from the vending machine, does the device grant an item or transmit on a channel?",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            label: "Required Item",
            description:
              "The item required for a player to purchase from the vending machine",
            type: "itemId",
            validators: [null],
            props: {},
          },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How much of the required item a player must have to purchase from the vending machine",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
            props: { min: 0, max: 999999999999999, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            label: "Granted Item",
            description:
              "When a player purchases from the vending machine, what item is granted to them?",
            type: "itemId",
            validators: [null],
            props: {},
            hideIf: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "When a player purchases the item from the vending machine, the device sends a signal on the selected channel",
          },
        ...
        },
        {
          ...
          option: {
            label: "Item Image",
            description:
              "Supply an image shown for the item in the vending machine. Custom images are not allowed. Refer to the Gimkit Creative documentation for usage of icon images.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: { placeholder: "Text here...", maxLength: 64 },
        ...
        },
        {
          ...
          option: {
            label: "Item Name",
            description:
              "The name of the item being purchased from the vending machine. By default, the name of the Granted Item is used.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: { placeholder: "Text here...", maxLength: 64 },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "An optional description of the item being purchased from the vending machine.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
            props: { placeholder: "Text here...", maxLength: 128 },
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, the vending machine will deactivate after the item is purchased.",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, the cost of the item will increase based on the number of players in-game",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How much the cost of the item increases per additional player",
            type: "numberInput",
            defaultValue: 0,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, players can fund the vending machine to decrease the cost of the item",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "For funding, the current price of the item is applied to who?",
            hideIf: [
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, the vending machine will be out of stock after a certain amount of purchases",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The maximum amount of purchases that can be made from the vending machine before it goes out of stock",
            type: "numberInput",
            defaultValue: 10,
            validators: [null],
            props: { min: 1, max: 999, step: 1, allowEmpty: false },
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "The current stock of the vending machine is applied to who?",
            hideIf: [
              [{ key: "useLimitedStock", compare: "NOT_EQUAL", value: true }],
              [{ key: "deactivateOnPurchase", compare: "EQUAL", value: true }],
            ],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "When enabled, the cost of the item will be added to the end of the item's name",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Is this vending machine available to make purchases from when the game starts?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activate the vending machine when the device receives a signal from the selected channel",
          },
          categories: ["Availability", "Channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Deactivate the vending machine when the device receives a signal from the selected channel",
          },
          categories: ["Availability", "Channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "Which team is allowed to purchase from the vending machine?",
            type: "select",
            validators: [null],
            defaultValue: "__ANY_TEAM__",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Attempt to purchase an item from the vending machine when the device receives a signal from the selected channel",
          },
          categories: ["Channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When a player attempted to purchase an item from the vending machine, but failed, the device sends a signal on the selected channel",
          },
          categories: ["Channels"],
        },
        {
          ...
          option: {
            label: "Interaction Duration",
            description:
              "How long does a player have to interact with the vending machine to make the purchase?",
            type: "select",
            validators: [null],
            defaultValue: 1,
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Match the colors of the vending machine to the granted item's rarity",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            label: "Rays Color",
            description:
              "The color of the rays rotating on the vending machine",
            type: "color",
            defaultValue: "#f7d253",
            validators: [null],
            hideIf: [
      ...
      options: [
        {
          ...
          option: {
            label: "Play Bahavior",
            description:
              "What should happen when the device is triggered and an audio line is already playing?",
            type: "select",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            defaultValue: 1,
            validators: [null],
            props: { min: 0, max: 1, step: 0.001, allowEmpty: false },
          },
        },
        {
          key: "playChance",
          option: {
            label: "Play Chance",
            description:
              "Percentage chance that the voice line will play when triggered",
            type: "numberInput",
            defaultValue: 100,
            validators: [null],
            props: { min: 0, max: 100, step: 1, allowEmpty: false },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Enter the identifier of the Ball you want to track. Make sure to set the identifier on the proper Ball Device as well.",
            type: "textInput",
            defaultValue: "",
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Automatically deactivate the waypoint when a player is within range to it",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Distance (in meters) the waypoint will automatically deactivate when a player is within range to it",
            type: "numberInput",
            defaultValue: 3,
            validators: [null],
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Start following the triggering player when the device receives a signal from the selected channel",
            hideIf: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Stop following the currently tracked player when the device receives a signal from the selected channel",
            hideIf: [
              [{ key: "target", compare: "NOT_EQUAL", value: "player" }],
            ],
          },
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "Is the waypoint active & visible when the game starts?",
            defaultValue: true,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "Activation/deactivation of the waypoint applies to who?",
          },
        },
      ],
    },
      ...
      options: [
        ...
        },
        {
          ...
          option: {
            label: "Allowed Team",
            description:
              "The wire's pulse will be blocked if the message is not from a player on this team",
            type: "select",
            validators: [null],
            defaultValue: "__ANY_TEAM__",
            props: {
  ...
  },
  {
    ...
    name: "Zone",
    description:
      "Detect when players enter certain areas, and change characteristics about those areas",
    optionSchema: {
      categories: {
        categories: [
          { id: "Featured", name: "Featured" },
      ...
      options: [
        {
          ...
          option: {
            ...
            description:
              "When player enters the zone, the device sends a signal on the selected channel",
          },
          categories: ["Featured", "Channels"],
        },
        {
          ...
          option: {
            ...
            description:
              "When player leaves the zone, the device sends a signal on the selected channel",
          },
          categories: ["Featured", "Channels"],
        },
        {
        ...
        },
        {
          ...
          option: {
            label: "Allow Usable Drop",
            description:
              "Are players allowed to drop usable items in the zone?",
            type: "select",
            validators: [null],
            defaultValue: "Do Not Override",
            props: {
        ...
        },
        {
          ...
          option: {
            ...
            type: "select",
            description:
              "If enabled, items dropped in the zone will automatically disappear after a set amount of time",
            defaultValue: false,
            validators: [null],
            props: {
              options: [
        ...
        },
        {
          ...
          option: {
            ...
            description:
              "How long (in seconds) it takes for items to disappear after being dropped in the zone",
            type: "numberInput",
            defaultValue: 1,
            validators: [null],
